                    ...
                    <div class="col-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h4 class="box-title">Master Data Product</h4>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                <div class="table-responsive">
                                    <table id="db_master_product" class="table table-bordered table-striped" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>SKU</th>
                                                <th>Part Name</th>
                                                <th>Part Number API</th>
                                                <th>Part Number Cust.</th>
                                                <th>Job Number</th>
                                                <th>Address</th>
                                                <th>Time Production</th>
                                                <th>Packaging</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?= $i; ?></td>
                                                    <td><?= $row1['sku_maris']; ?></td>
                                                    <td><?= $row1['part_name']; ?></td>
                                                    <td><?= $row1['pn_api']; ?></td>
                                                    <td><?= $row1['pn_cust']; ?></td>
                                                    <td><?= $row1['job_no']; ?></td>
                                                    <td><?= $row1['address']; ?></td>
                                                    <td><?= $row1['time_production']; ?></td>
                                                    <td><?= $row1['packaging']; ?></td>
                                                </tr>
                                            <?php
                                                $i++;
                                            }
