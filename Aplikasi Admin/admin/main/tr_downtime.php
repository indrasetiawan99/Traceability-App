                    ...
                    <div class="col-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h4 class="box-title">Data Downtime</h4>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                <div class="table-responsive">
                                    <table id="tr_downtime" class="table table-bordered table-striped" style="width:100%">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <?php
                                            $query1 = "SELECT * FROM downtime ORDER BY id DESC";
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?= $i; ?></td>
                                                    <td><?= $row1['category']; ?></td>
                                                    <td><?= $row1['user_start']; ?></td>
                                                    <td><?= $row1['start_downtime']; ?></td>
                                                    <td><?= $row1['user_end']; ?></td>
                                                    <td><?= $row1['end_downtime']; ?></td>
                                                    <td><?= $row1['description']; ?></td>
                                                    <td><?= round($row1['total_time'] / 60) . '\''; ?></td>
                                                </tr>
                                            <?php
                                                $i++;
                                            }
