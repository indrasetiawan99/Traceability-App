                    ...
                    <div class="col-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h4 class="box-title">Master Data User</h4>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                <div class="table-responsive">
                                    <table id="db_master_user" class="table table-bordered table-striped" style="width:100%">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <?php
                                            $query1 = "SELECT * FROM master_user ORDER BY nik ASC";
