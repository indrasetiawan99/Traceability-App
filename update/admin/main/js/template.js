...
//Primary use:	Power BI Admin - Responsive Admin Template
...
+function ($) {
  ...
  PushMenu.prototype.init = function () {
    ...
    this.close() //Untuk auto-hide sidebar di awal program
  ...
  PushMenu.prototype.toggle = function () {
    ...
    if (!isOpen) {
      ...
      this.close() //tambahkan ini diawal program untuk auto-hide sidebar
    }
  }
